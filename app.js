...
// let formEl = document.getElementById("formID");   typo error
...
function handleSubmit(event) {
    ...
    newDrink.render();
     ...
     newDrink.renderTable(); //when add this here the data added to the table
    saveData(allDrinks);
}
...
Drink.prototype.renderTable = function () {
   ...
   // tr.appendChild(priceTD);  typo error
